...
open class FetchNewsAPI {
     ...
     */
    @discardableResult
    open class func getAllNews(q: String, apiKey: String, page: Int, pageSize: Int, language: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: NewsList?, _ error: Error?) -> Void)) -> RequestTask {
